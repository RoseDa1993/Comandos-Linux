Esta es una lista de comandos junto a sus funciones que te pueden ser utiles si estas aprendiendo a utilizar Linux. 

sudo su > cambiar a user root
...
tar -czvf projects.tar.gz > comprimir
